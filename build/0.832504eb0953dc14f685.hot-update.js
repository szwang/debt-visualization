	...
	var VizPage = function (_React$Component) {
	  ...
	  _createClass(VizPage, [{
	    ...
	    value: function drawViz() {
	      var visualization = _d3plus2.default.viz().container(".viz").type("network").data(sample_data).edges(connections).id("name").nodes(positions).size("size").edges().draw();
	    }
	  }, {
	    key: 'render',
...
//# sourceMappingURL=0.832504eb0953dc14f685.hot-update.js.map