	...
	var VizPage = function (_React$Component) {
	  ...
	  _createClass(VizPage, [{
	    ...
	    value: function drawViz() {
	      var visualization = _d3plus2.default.viz().container(".viz").type("network").edges(connections).id("name").nodes(positions).size("size").edges().draw();
	    }
	  }, {
	    key: 'render',
...
//# sourceMappingURL=0.7b7e6ab2758b8ba9af7d.hot-update.js.map