	...
	var VizPage = function (_React$Component) {
	  ...
	  _createClass(VizPage, [{
	    ...
	    value: function drawViz() {
	      ...
	      var visualization = _d3plus2.default.viz().container(".viz").type("bar").data(sample_data2).id("name").x("year").y("value").x({ value: "year", stacked: true }).draw();
	    }
	  }, {
	    key: 'render',
...
//# sourceMappingURL=0.97b4ff8de7fb34c32c0a.hot-update.js.map